<template>
    <div>
      ...
      <nav 
        ...
        class="border border-blue-800 border-r-[0px] md:translate-x-0 md:fixed md:top-1/4 md:right-0 md:w-content md:h-content md:bg-black md:text-white md:p-3 md:rounded-tl-md md:rounded-bl-md md:transition-transform md:duration-300 md:transform"
      >
        <ul>
